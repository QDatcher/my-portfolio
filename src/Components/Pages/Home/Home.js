                    ...
                    <div className='about-section'>
                        ...
                        <div className="about-content">
                            ...
                            <p className="inline">
                                    ...
                                    <br/>
                                    <br/>
                                    Looking for a better source of income and career, I joined a sales company that was looking to expand to Texas selling cell service to business owners in the Houston area. Throughout my time in sales, I picked up soft skills pertaining to leadership, communication, and work ethic, however I knew the world of sales wasn't a longterm option for me so when the pandemic hit, I moved back to DC and was lucky to get recommended to my current job at Congressional Cemetery studying code on the side until I started my bootcamp.
                                    <br />
                                    <br />
                    ...
                    <div className='hobbies-section'>
                        ...
                        <div class="hobbies-container">
                            <figure class="first-hobby">
                                <iframe src="https://www.youtube.com/embed/X-Q39BG6EsU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                            ...
                            <figure class="second-hobby">
                                <video  controls>
                                    {/* <source src="./assets/videos/sweep.mp4" type="video/mp4"> */}
                                </video>
                                <figcaption><span className='hobbyName'>Kickboxing/MMA</span> - For the past year and a half I've been learning how to kicbox and more recently have started jiujitsu and some catch wrestling (My skill level is still very beginner as shown in my sparring video)</figcaption>
                            </figure>
